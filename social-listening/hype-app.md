---
description: Automated Social Campaigns, powered by Daily
---
...
* **Email**: if you wish to participate in the bounty (link missing), then please enter the email you've used to register on Daily's Community Site. If you don't care about the bounty then just enter any email (or make one up).&#x20;
...
In this example you'll see that there's a Hype Pool set up for Daily, or "DLY". A few things to note,&#x20;
...
* **Campaign Keyword**: the Hype Pool is about Daily the project, but this specific campaign (what the Pool wishes to hype up) is about the mainnet launch. So if you include the keyword "mainnet" in your Telegram messages, it'll be weighted even more.&#x20;
...
Make sure that the wallet you connect is on the same network as the rewards are for the Hype Pool you participated in. For example, if you participated in a Daily Hype Pool, then make sure you're connected to the Daily Mainnet. You could of course be participating in as many Hype Pools as you'd like, but be sure to be connected to the right network for the pools you're trying to claim rewards from.&#x20;
